...
def start(message):
	...
	if str(message.chat.id) in op:
		...
		contact_button = types.InlineKeyboardButton(text="- Programmer ⚡", url="https://t.me/Lx0b2")
		kilp = types.InlineKeyboardButton(text="- Channel ⚡", url="https://t.me/Pythonln")
...
• 𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑 - @Lx0b2</strong>''',reply_markup=keyboard)
	else:
...
- Process Time : <code>{"{:.1f}".format(execution_time)} Seconds.  seconds </code>
--------------------------------------------
- Programmer • @Lx0b2</strong>''',f'''<strong>- Hello Boss New Approved Charge Card ✅
--------------------------------------------
- GateWay -> Stripe Auth ViP ♕ .
- Message -> {last}
--------------------------------------------
...
- Programmer -> @Lx0b2 </b>''', reply_markup=mes)
					msg=f'''<b>• 𝗔𝗣𝗣𝗥𝗢𝗩𝗘𝗗 !✅
